              ...
              <>
                ...
                {submitted.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {submitted.map(team => {
                      const problem = eventDetails.problemStatements?.find(p => p.id === team.problemStatementId);
                      const hasScore = team.score != null && team.score > 0;
                      return (
                        <div key={team.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col gap-3">
                          {/* Team name + score badge */}
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              {hasScore ? (
                                ...
                                <span className="text-xs text-gray-400 bg-gray-100 px-2.5 py-1 rounded-full">Not scored</span>
                              )}
                              {team.shortCode && (
                                <span className="text-xs font-mono text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">#{team.shortCode}</span>
                              )}
                            </div>
                          </div>
